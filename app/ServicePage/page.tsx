...
const page = () => {
  return (
    <section className=" flex flex-col justify-center items-center min-h-screen bg-black text-white px-4 text-center sm:px-8 lg:px-16 gap-8 my-[125px]">
      ...
      <div className="flex flex-wrap gap-4 justify-center mb-16">
       ...
       <h2 className="sm:text-5xl lg:text-5xl text-center font-bold mb-6 bg-gradient-to-b from-[#FEFEFE] to-[#39B6FD] bg-clip-text text-transparent">
        Our Services
      </h2>
      <p className="text-white mb-10 max-w-[900px]  text-sm sm:text-base md:text-lg text-center sm:text-left">
        Comprehensive technology solutions tailored to your busniess needs.
      </p>
      <div className="flex flex-wrap justify-center gap-13 max-w-6xl mx-auto text-left">
        <div className="flex-1 min-w-[300px] max-w-[350px] border border-[#444444] rounded-lg p-6 bg-[#1B1818] hover:border-blue-400 transition">
          ...
          <p className="text-[#C9C9C9] mb-3">
            Custom websites and web applications that drive business growth with
        ...
        <div className="flex-1 min-w-[300px] max-w-[350px] border border-[#444444] rounded-lg p-6 bg-[#1B1818] hover:border-blue-400 transition">
          <h3 className="text-[#FEFEFE]text-lg font-semibold mb-3 text-white">
            Mobile App Development
          </h3>
          <p className="text-[#C9C9C9] mb-3">
            Native and cross-platform mobile solutions that engage users across
            all devices.
          </p>
          <ul className="list-disc list-inside text-[#C9C9C9] space-y-1">
        ...
        <div className="flex-1 min-w-[300px] max-w-[350px] border border-[#444444] rounded-lg p-6 bg-[#1B1818] hover:border-blue-400 transition">
          ...
          <p className="text-[#C9C9C9] mb-3">
            Robust, scalable backend systems and APIs that power modern
            applications.
          </p>
          <ul className="list-disc list-inside text-[#C9C9C9] space-y-1">
        ...
        <div className="max-w-4xl mx-auto pt-[38px] mt-28 p-8 bg-[#1B1818] rounded-lg border border-[#444444] text-center space-y-9">
          ...
          <p className="text-[#FEFEFE] text-center text-md leading-relaxed px-6 text-bottom">
            ...
            that fits your needs and budget. Our team of experts is ready to
